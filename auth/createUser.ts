...
const createResponse = (statusCode: number, body: CreateUserResponse): APIGatewayProxyResult => ({
    statusCode,
    headers: {
...
const extractUserFromToken = (authHeader?: string): UserInfo => {
...
const isAuthorized = (userRole: string): boolean => {
    const allowedRoles = ['Admin', 'SuperAdmin'];
    return allowedRoles.includes(userRole);
};

const validateCreateUserRequest = (body: any): { isValid: boolean; error?: string } => {
